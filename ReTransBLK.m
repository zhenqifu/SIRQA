function [Block_change_info, Information_loss] = ReTransBLK( Func_aprox_X, Func_aprox_Y, BLOCK_SIZE, bi, bj)
...
%     Block_change_info = zeros(block_h, block_w, 2);
%     for bi = 1:block_h
%         for bj = 1:block_w
            ...
            Information_loss = size(CSet_Ret(:,1),1);
